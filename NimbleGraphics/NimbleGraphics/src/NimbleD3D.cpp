...
NimbleD3D::NimbleD3D()
{
	...
	m_projectionMatrix = shared_ptr<Matrix>(new Matrix());
	m_worldMatrix = shared_ptr<Matrix>(new Matrix());
}

NimbleD3D::NimbleD3D(const NimbleD3D& other)
{
}
...
bool NimbleD3D::Init(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
...
ComPtr<ID3D11Debug> NimbleD3D::GetDebugLayer()
{
	return m_debugLayer;
}
...
void NimbleD3D::CreateRenderTarget(int screenWidth, int screenHeight)
{
	...
	*m_projectionMatrix = XMMatrixPerspectiveFovLH(XM_PIDIV4, screenAspect, 0.1f, 1000.0f);
}
...
void NimbleD3D::BeginScene(DirectX::XMVECTORF32 clearColor)
{
...
ComPtr<ID3D11Device> NimbleD3D::GetDevice()
{
	return m_device;
}

ComPtr<ID3D11DeviceContext> NimbleD3D::GetDeviceContext()
{
	return m_deviceContext;
}

shared_ptr<Matrix> NimbleD3D::GetProjectionMatrix()
{
	return m_projectionMatrix;
}

shared_ptr<Matrix> NimbleD3D::GetWorldMatrix()
{
	return m_worldMatrix;
}

DXGI_SWAP_CHAIN_DESC NimbleD3D::GetSwapChainDesc()
{
	return m_swapChainDesc;
}

void NimbleD3D::GetVideoCardInfo(char* cardName, int& memory)
{
...
auto NimbleD3D::GetSwapChain() -> ComPtr<IDXGISwapChain>
{
	return m_swapChain;
}
...
void NimbleD3D::UpdateProjectionMatrix(int width, int height, float screenNear, float screenFar)
{
	...
	*m_projectionMatrix = XMMatrixPerspectiveFovLH(XM_PIDIV4, screenAspect, screenNear, screenFar);
}

HWND NimbleD3D::getHwnd()
{
	return m_hwnd;
}