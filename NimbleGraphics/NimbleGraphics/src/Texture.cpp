...
Texture::Texture(ComPtr<ID3D11Device> device, ComPtr<ID3D11DeviceContext> deviceContext, string textureName)
{
...
bool Texture::Init(ComPtr<ID3D11Device> device, ComPtr<ID3D11DeviceContext> deviceContext, string filename)
{
	bool result;
	int height, width;
