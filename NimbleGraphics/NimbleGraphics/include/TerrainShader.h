...
public:
	...
	bool Draw(ComPtr<ID3D11DeviceContext> deviceContext, int indexCount, const Matrix& worldMatrix,
	          const Matrix& viewMatrix, const Matrix& projectionMatrix, const Light& light, TextureArray& textures);
	...
	bool SetShaderParameters(ComPtr<ID3D11DeviceContext> deviceContext, const Light& light, TextureArray& textures);
private:
